...
export class BlisterComponent implements OnInit {
  ...
  blisters:any=[
    {
      tipe: 'Blister',
      pathImage: 'assets/imgPokemon/blister/BLISTER QUADRUPLO POKEMON - ESTILOS DE BATALHA ESPADA E ESCUDO 5 EEVEE.png',
      name: 'Pokémon blister quadruplo estilos de batalha espada e escudo 5 Eevee',
      price: 'R$ 29,90',
    },
    {
      tipe: 'Blister',
      pathImage: 'assets/imgPokemon/blister/BLISTER QUADRUPLO POKEMON - ESTILOS DE BATALHA ESPADA E ESCUDO 5 JOLTEON.png',
      name: 'Pokémon blister quadruplo estilos de batalha espada e escudo 5 Jolteon',
      price: 'R$ 29,90',
    },
    {
      tipe: 'Blister',
      pathImage: 'assets/imgPokemon/blister/BLISTER TRIPLO POKEMON - ESTILOS DE BATALHA ESPADA E ESCUDO 5 ARROKUDA.png',
    ...
    {
      tipe: 'Blister',
      pathImage: 'assets/imgPokemon/blister/POKEMON BLISTER UNITARIO - BOOSTER ESPADA E ESCUDO 6 REINADO ARREPIANTE.png',
